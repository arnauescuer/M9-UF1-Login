<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "GET"){
        $correo=$_GET['reEmail'];
          ...
          $sql3 = " UPDATE  users  SET resetPassExpiry=addtime(now(),3000) ,  resetPassCode='$hash'  WHERE  mail='$correo' ";
	...
	'<a href="http://localhost/EJCRISMAS/resetPassword.php?codi='.$codi.'&mail='.$correo.'" target="_blank" title="Link de Verificacio" rel="nofollow">I want to Reset My Password
    </a>'.
	'</body>');
