    ...
    if(isset($_SESSION["usuari"])){
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            try{
              ...
              else if(isset($_GET["passwordreset"]) && $_GET["passwordreset"]=='1'){
                $formPassReset=1;
                // echo $rescorreu;
                $hola=$_GET["correo"];
              }else if(isset($_GET["passwordreset"]) && $_GET["passwordreset"]=='0'){
                $formPassReset=0;  
              }else if (isset($_GET["reEmail"]))
              {
                $hola1=$_GET["reEmail"];
                include('resetPasswordSend.php');
              }
...
<?php
  if ($formPassReset==1)
  {
    echo '<div class="modal-content" style="margin-top:18%; width:50%; margin-left:auto; margin-right:auto;">
            <div class="modal-header">
              <h5 class="modal-title">RESET DE LA PASSWORD</h5>
            </div>
            <div class="modal-body">
            <form action="newpass.php" method="post">
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" readonly class="form-control-plaintext" id="staticEmail" name="recorreu" value="'.$hola.'">
                </div>
              </div>
              <div class="form-group row">
                <label for="inputPassword" class="col-sm-2 col-form-label">Password</label>
                <div class="col-sm-10">
                  <input type="password" class="form-control" id="inputPassword1" placeholder="Password" name="respass1">
                </div>
              </div>
              <div class="form-group row">
                <label for="inputPassword" class="col-sm-2 col-form-label">Confirm Password</label>
                <div class="col-sm-10">
                  <input type="password" class="form-control" id="inputPassword2" placeholder="Password" name="respass2">
                </div>
              </div>
            </div>
              <div class="modal-footer">
